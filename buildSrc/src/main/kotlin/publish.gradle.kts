    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/antoniuswisnu14/kotlin/")
                ...
                developers {
                    developer {
                        id.set("antoniuswisnu14")
                        name.set("antoniuswisnu14")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/antoniuswisnu14/kotlin.git")
                    developerConnection.set("scm:git:ssh://github.com/antoniuswisnu14/kotlin.git")
                    url.set("https://github.com/antoniuswisnu14/kotlin/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/antoniuswisnu14/kotlin/issues")
                }
            }
        }
    }
